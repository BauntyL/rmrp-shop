      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <motion.h1 
                className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 via-blue-500 to-purple-600 bg-clip-text text-transparent flex items-center gap-3"
            ...
            {isAuthenticated && (
              ...
              >
                <Button 
                  ...
                  className="relative overflow-hidden group bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-xl"
                >
          ...
          <Card className="mb-8 bg-slate-800/50 backdrop-blur-lg border-slate-700/50 shadow-xl">
            <CardHeader>
              ...
              <CardDescription className="text-slate-300">
                Найдите именно тот автомобиль, который вам нужен
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-slate-700/50 backdrop-blur-sm border-slate-600/50 text-white placeholder:text-slate-400 transition-all duration-200 focus:bg-slate-700/70 focus:border-blue-500/50"
                />
              </div>
        ...
        >
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-semibold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              Найдено {filteredProducts.length} автомобилей
            </h2>
            <div className="flex gap-2">
              <Badge variant="secondary" className="bg-gradient-to-r from-blue-500 to-blue-600 text-white border-none">
                {selectedServer === "all" ? "Все серверы" : servers.find((s: Server) => s.id.toString() === selectedServer)?.name}
              </Badge>
        ...
        {productsLoading ? (
          ...
          >
            <Card className="text-center py-16 bg-slate-800/50 backdrop-blur-lg border-slate-700/50">
              <CardContent>
                <motion.div animate={floatingAnimation}>
                  <Car className="h-20 w-20 text-slate-400 mx-auto mb-4" />
                </motion.div>
                <h3 className="text-2xl font-semibold text-white mb-2">Автомобили не найдены</h3>
                ...
                {isAuthenticated && (
                  ...
                  >
                    <Button 
                      onClick={() => setIsCreateModalOpen(true)} 
                      className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-xl hover:shadow-lg transition-all duration-300"
                    >
