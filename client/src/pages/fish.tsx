  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Tips Section */}
        <Card className="mt-12 bg-cyan-50 border-cyan-200">
          <CardHeader>
            <CardTitle className="text-cyan-900">Советы по покупке рыбы</CardTitle>
          </CardHeader>
          <CardContent className="text-cyan-800">
            <ul className="space-y-2">
              <li>• Проверьте свежесть и качество рыбы</li>
              <li>• Узнайте место и способ ловли</li>
              <li>• Договоритесь о быстрой передаче товара</li>
              <li>• Убедитесь в соответствии размера и веса</li>
            </ul>
          </CardContent>
        </Card>
      </main>
