      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            {isAuthenticated && (
              <Button onClick={() => setIsCreateModalOpen(true)} className="flex items-center gap-2 bg-cyan-600 hover:bg-cyan-700 text-white">
        ...
        {productsLoading ? (
          ...
          <Card className="text-center py-16 bg-slate-800 border-slate-700">
            <CardContent>
              <Fish className="h-16 w-16 text-slate-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-white mb-2">Рыба не найдена</h3>
              ...
              {isAuthenticated && (
                <Button onClick={() => setIsCreateModalOpen(true)} className="bg-cyan-600 hover:bg-cyan-700 text-white">
