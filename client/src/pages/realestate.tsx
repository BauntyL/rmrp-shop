...
import CreateRealEstateModal from "@/components/create-realestate-modal";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <motion.h1 
                className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-green-400 via-emerald-500 to-teal-600 bg-clip-text text-transparent flex items-center gap-3"
            ...
            {isAuthenticated && (
              ...
              >
                <Button 
                  ...
                  className="relative overflow-hidden group bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-3 rounded-xl"
                >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-slate-700/50 backdrop-blur-sm border-slate-600/50 text-white placeholder:text-slate-400 transition-all duration-200 focus:bg-slate-700/70 focus:border-green-500/50"
                />
              </div>
        ...
        >
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-semibold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">
        ...
        {productsLoading ? (
          ...
          >
            <Card className="text-center py-16 bg-slate-800/50 backdrop-blur-lg border-slate-700/50">
              <CardContent>
                <motion.div animate={floatingAnimation}>
                  <Home className="h-20 w-20 text-slate-400 mx-auto mb-4" />
                </motion.div>
                <h3 className="text-2xl font-semibold text-white mb-2">Недвижимость не найдена</h3>
                ...
                {isAuthenticated && (
                  ...
                  >
                    <Button 
                      onClick={() => setIsCreateModalOpen(true)} 
                      className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-3 rounded-xl hover:shadow-lg transition-all duration-300"
                    >
