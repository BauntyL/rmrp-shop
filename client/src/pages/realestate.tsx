    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mt-12 bg-green-50 border-green-200">
          <CardHeader>
            <CardTitle className="text-green-900">Советы по покупке недвижимости</CardTitle>
          </CardHeader>
          <CardContent className="text-green-800">
            <ul className="space-y-2">
              <li>• Проверьте расположение недвижимости на карте</li>
              <li>• Убедитесь в наличии всех необходимых документов</li>
              <li>• Осмотрите внутреннее убранство и состояние</li>
              <li>• Договоритесь о способе оплаты и передачи прав</li>
            </ul>
          </CardContent>
        </Card>
      </main>
